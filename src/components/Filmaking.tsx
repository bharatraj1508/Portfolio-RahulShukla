...
const Filmaking = () => {
  ...
  return (
    <>
      <div id="filmaking" className="mt-32">
            ...
            <div className="flex flex-col-reverse gap-8 md:flex-row">
              <div className="text-black md:w-2/3">
                <p className="text-base md:text-lg leading-relaxed">
                  ...
                  mystery. Striving to extinguish darkness, Sanjay's path veers
                  unexpectedly when a father pleads for help with a cryptic
                  70-year-old tape recording threatening his daughter.
                  <br />
                  <br />
                  Delving further, Sanjay uncovers unsettling connections
                  between the tape and tragic events spanning decades. The core
                  of the narrative resides in his exploration of Ant-Raal, where
                  reality's fabric bends. Armed with determination and the tape
                  recorder, he must navigate seven episodes, unraveling victims
                  and culprits.
                  <br />
                  <br />
                  "Ant-Raal: The Demon's Revelation" is a psychological thriller
                  transcending good, evil, life, and death. With mystery,
                  suspense, and supernatural intrigue, it captivates, prompting
                  contemplation of the human psyche and the enigmatic beyond.
                </p>
              </div>
          ...
          <div className="bg-gray-100 p-6 md:p-10 rounded-lg shadow-lg mt-8 space-y-6 md:mt-24 md:space-y-0 md:space-x-8">
            <div className="flex flex-col-reverse gap-8 md:flex-row-reverse">
              <div className="text-black flex flex-col justify-center items-center">
                ...
                <p className="text-base md:text-lg leading-relaxed">
                  Soul eaters, a film revolving around a women who left her well
                  settled job because of the male dominated culture of that
                  company and now she is looking for another job and giving
                  interviews on a regular basis in a hope that she can feel
                  secure, but in one morning she notice a bruise on her neck
                  which she tries to cover up with makeup.
                  <br />
                  <br />
                  ...
                  disgusting marks on her body but fails. In the end she accepts
                  them.
                </p>
              </div>
              <div className="flex justify-center items-center">
                <img
                  src={soulEaters}
                  className="rounded-lg shadow-lg max-w-full md:max-w-md md:h-90"
                  alt=""
                />
              </div>
            </div>
          ...
          {othersImages.map(({ id, imagePath, title, role, link }) => (
            <div
              ...
              <img
                src={imagePath}
                alt=""
                className="rounded-md duration-200 hover:scale-105 h-2/3"
              />
