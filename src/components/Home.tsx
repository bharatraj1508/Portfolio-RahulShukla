        ...
        <div className="md:hidden mt-10">
          <div className="flex items-center justify-center h-screen">
            <div className="flex flex-col space-y-10 px-10">
              <h2 className="text-2xl sm:text-7xl font-bold text-black">
                My Artistic Voyage
              </h2>
              <p>
                ...
                expressions. My adeptness across artistic disciplines showcases
                my fervor for creative exploration, fostering deep connections
                with audiences through various mediums
              </p>
